                    ...
                    <div class="paging">
                        <ul>
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li><a href="${pageContext.servletContext.contextPath}/QaCommunity/list?nowPage=${pVO.nowPage-1}&${param.searchKey!=null ? 'searchKey=' + param.searchKey : ''}&${param.searchWord!=null ? 'searchWord=' + param.searchWord : ''}">prev</a></li>
                                </c:otherwise>
                            </c:choose>
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <li class="paging-button">
                                                <a href="${pageContext.servletContext.contextPath}/QaCommunity/list?nowPage=${p}${(not empty param.searchKey) ? '&searchKey=' + param.searchKey : ''}${(not empty param.searchWord) ? '&searchWord=' + param.searchWord : ''}">${p}</a>
                                            </li>
                                        </c:otherwise>
                                    </c:choose>
                                </c:if>
                            ...
                            <c:choose>
                                <c:when test="${pVO.nowPage < pVO.totalPage}">
                                    <li><a href="${pageContext.servletContext.contextPath}/QaCommunity/list?nowPage=${pVO.nowPage + 1}&${param.searchKey!=null ? 'searchKey=' + param.searchKey : ''}&${param.searchWord!=null ? 'searchWord=' + param.searchWord : ''}">next</a></li>
                                </c:when>
                                <c:otherwise>
                                    <li>next</li>
                                </c:otherwise>
